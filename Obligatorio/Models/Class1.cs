...
namespace Obligatorio.Models
{
    public class Class1
    {
        ...
        public System.Web.Mvc.SelectList cantidadCuotas { get; set; }
        ...
        private void cargarCantidadCuotas()
        {
            RepositorioConfiguraciones db = new RepositorioConfiguraciones();
            this.cantidadCuotas = new SelectList(db.CuotasyTasas(), "cuotas", "cuotas");
        }
